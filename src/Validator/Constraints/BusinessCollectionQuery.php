...
/**
 * The business collection query constraint.
 *
 * @package App\Validator\Constraints
 * @author  Clément Cazaud <opportus@gmail.com>
 * @license https://github.com/opportus/demo-rest-api/blob/master/LICENSE.md MIT
 */
class BusinessCollectionQuery extends CollectionConstraint
{
    /**
     * Constructs the business collection query constraint.
     */
